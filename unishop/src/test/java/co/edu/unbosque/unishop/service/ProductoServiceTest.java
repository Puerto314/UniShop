 ...
 *
 * ✅ SEGURIDAD DE DATOS:
 *    - El ProductoRepository es un MOCK (Mockito): NUNCA toca la base de datos real.
 *    - No se persiste, modifica ni elimina ningún producto real.
...
public class ProductoServiceTest {
    ...
    void create_siempreRetorna1() {
        // ProductoService.create() siempre retorna 1 (no tiene validaciones de unicidad)
    ...
    void updateById_asignaIdCorrectamente() {
        // Verifica que el producto actualizado recibe el ID correcto antes de guardarse
        ProductoDTO datosActualizados = new ProductoDTO(
        ...
        when(productoRepository.save(any(Producto.class))).thenAnswer(invocation -> {
            ...
            // El producto guardado debe tener el ID = 5L
