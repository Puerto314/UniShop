...
/**
 * Pruebas unitarias para AdminController, ClienteController y ProductoController.
 *
 * ✅ SEGURIDAD DE DATOS:
 *    - Todos los Services son MOCKS (Mockito): NUNCA se accede a la base de datos.
 *    - No se levanta contexto de Spring (sin @SpringBootTest): 100% unitario.
...
public class ControllerTest {
    ...
    // ══════════════════════════════════════════════════════════════════════
    // PRODUCTO CONTROLLER — /mostrartodo
    // ══════════════════════════════════════════════════════════════════════
