...
public class AdminService {
     ...
     * La contraseña se almacena codificada con BCrypt.
     * Retorna:
    ...
    public int create(String nombreUsuario, String contraseniaUsuario) {
        try {
            ...
            // CORRECCIÓN: la contraseña se codifica con BCrypt antes de guardar
            Admin admin = new Admin(nombreUsuario, passwordEncoder.encode(contraseniaUsuario), CODIGO_ADMIN_FIJO);
    ...
    public List<AdminDTO> getAll() {
        ...
        adminRepository.findAll().forEach(a -> {
            AdminDTO dto = mapper.map(a, AdminDTO.class);
            lista.add(dto);
        });
        return lista;
    }
     ...
     * La nueva contraseña se codifica con BCrypt.
     * Retorna:
     *   1  -> actualizado
    ...
    public int updateById(Long id, String nombreUsuario, String contraseniaUsuario) {
        ...
        // CORRECCIÓN: contraseña codificada con BCrypt
        Admin admin = new Admin(nombreUsuario, passwordEncoder.encode(contraseniaUsuario), CODIGO_ADMIN_FIJO);
        admin.setId(id);
        adminRepository.save(admin);
        return 1;
